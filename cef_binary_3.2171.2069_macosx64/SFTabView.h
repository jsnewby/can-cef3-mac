...
@interface SFTabView : NSView {
    ...
    CALayer *deleteThisTab; //devika tab to delete using close circle control
    ...
    //Devika
    NSMutableArray *relatedURLs; //store the URL associated with each new tab
    NSString * curTabURL; //cuurent tab URL
}
...
/** Devika
 @brief Returns an array contaning all the Tab View URLs.
 @return An array contaning all the Tab View URLs.
 */
- (NSArray *) relatedURLs;
